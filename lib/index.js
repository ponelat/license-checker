...
var flatten = function(options) {
    ...
    if (json.repository) {
        ...
        if (typeof json.repository === 'object' && typeof json.repository.url === 'string') {
            moduleInfo.repository = json.repository.url.replace('.git', '');
            moduleInfo.repository = moduleInfo.repository.replace('git+ssh://git@', 'git://');
            moduleInfo.repository = moduleInfo.repository.replace('git://github.com', 'https://github.com');
            moduleInfo.repository = moduleInfo.repository.replace('git@github.com:', 'https://github.com/');
            moduleInfo.repository = moduleInfo.repository.replace('git+https://', 'https://');
        }
    }
    if (json.url) {
        /*istanbul ignore next*/
